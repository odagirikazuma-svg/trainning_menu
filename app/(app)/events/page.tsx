  ...
  function renderLiftValue(
    ...
    return (
      <span>
        ...
        {diff && (
          <span
            className={`ml-1 text-[length:calc(11px+var(--fs-add))] ${
              diff.zero
                ? "text-neutral-500"
                : diff.positive
                  ? "text-emerald-400"
        ...
        return (
          ...
          >
            <div className="flex items-center justify-between gap-2">
              ...
              {submitted ? (
                <span className="rounded bg-emerald-800/60 px-2 py-0.5 text-[length:calc(11px+var(--fs-add))] font-medium text-emerald-300">
                  提出済み
                </span>
              ) : isOpenEvent ? (
                <span
                  className={`rounded px-2 py-0.5 text-[length:calc(11px+var(--fs-add))] font-medium ${
                    isOverdue
                ...
                <span className="rounded bg-neutral-700 px-2 py-0.5 text-[length:calc(11px+var(--fs-add))] text-neutral-300">
                  締切済み
                </span>
              )}
            </div>
                  ...
                  renderRow={(r) => (
                    ...
                    >
                      <span className="font-medium text-foreground">
                        {r.display_name}
                        {r.id === profile.id && (
                          <span className="ml-1 text-[length:calc(10px+var(--fs-add))] text-red-400">
                            (自分)
                          </span>
                        )}
                      </span>
...
function CommentThread({
  ...
  return (
    <div className="flex flex-col gap-2 border-t border-border-color pt-2">
      <p className="text-[length:calc(11px+var(--fs-add))] font-semibold text-neutral-500 dark:text-neutral-400">
        コメント
      </p>
      {loading ? (
            ...
            return (
              ...
              >
                <div className="flex items-center justify-between gap-2">
                  ...
                  <span className="text-[length:calc(10px+var(--fs-add))] text-neutral-500">
      ...
      {errorMsg && (
        <p className="rounded bg-red-950/40 p-2 text-[length:calc(11px+var(--fs-add))] text-red-400">
          {errorMsg}
        </p>
      )}
        ...
        <div className="flex flex-col gap-2 rounded-lg border border-border-color bg-surface-2 p-3 text-sm">
          <div className="flex items-center justify-between gap-2">
            <span className="font-medium">
              ...
              <span className="ml-2 text-[length:calc(11px+var(--fs-add))] font-normal text-neutral-500">
                〜{formatMonthDay(openEvent.deadline)}
              </span>
            </span>
            <span
              className={`shrink-0 rounded px-2 py-0.5 text-[length:calc(11px+var(--fs-add))] font-medium ${
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  <span className="text-[length:calc(11px+var(--fs-add))] text-neutral-500 dark:text-neutral-400">
        ...
        return (
          ...
          >
            ...
            >
              ...
              {submitted ? (
                <span className="shrink-0 rounded bg-emerald-800/60 px-2 py-0.5 text-[length:calc(11px+var(--fs-add))] font-medium text-emerald-300">
                  提出済み
                </span>
              ) : isOpenEvent ? (
                <span
                ...
                <span className="shrink-0 rounded bg-neutral-700 px-2 py-0.5 text-[length:calc(11px+var(--fs-add))] text-neutral-300">
                  締切済み
                </span>
              )}
            </button>
              ...
              return (
                <div className="flex flex-col gap-1.5 border-t border-border-color pt-2">
                  <div className="flex items-center justify-between">
                    <h4 className="text-[length:calc(11px+var(--fs-add))] font-semibold text-neutral-500 dark:text-neutral-400">
                      他の部員の振り返り
                    </h4>
                    <button
                      type="button"
                      ...
                      className="text-[length:calc(11px+var(--fs-add))] text-neutral-500 underline decoration-dotted dark:text-neutral-400"
                    >
      ...
      <div className="flex items-center justify-between">
        ...
        {selectedIds.size > 0 && (
          <button
            ...
            className="text-[length:calc(11px+var(--fs-add))] text-neutral-500 underline dark:text-neutral-400"
          >
            選択をクリア
          </button>
        )}
      ...
      {event === undefined ? (
          ...
          {results.length > 0 &&
            (() => {
              ...
              const diffSpan = (
                ...
                return (
                  <span
                    className={`ml-1 text-[length:calc(10px+var(--fs-add))] ${
                      diff.zero
                        ? "text-neutral-500"
                        : diff.positive
                          ? "text-emerald-400"
              ...
              return (
                <div className="max-w-md overflow-x-auto rounded-lg border border-border-color">
                  <table className="w-full table-fixed text-[length:calc(11px+var(--fs-add))]">
                    <colgroup>
                      <col className="w-[34%]" />
                      <col className="w-[22%]" />
                      <col className="w-[22%]" />
        ...
        <form onSubmit={handleCreate} className="flex flex-col gap-2">
          ...
          <div className="flex items-end gap-2">
            <label className="flex flex-1 flex-col gap-1 text-[length:calc(11px+var(--fs-add))] text-neutral-500 dark:text-neutral-400">
              締切日
              <input
                type="date"
                required
          ...
          {type === "match_reflection" && matchSubmissions.length > 0 && (
            <div className="flex flex-col gap-1.5">
              <button
                ...
                className="self-end text-[length:calc(11px+var(--fs-add))] text-neutral-500 underline decoration-dotted dark:text-neutral-400"
              >
