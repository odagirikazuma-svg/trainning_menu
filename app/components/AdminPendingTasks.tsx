        ...
        <>
          ...
          <ul className="flex flex-col gap-1">
            {visible.map((i) => (
              <li key={i.key}>
                ...
                >
                  <span
                    className={`shrink-0 rounded px-1.5 py-px text-[10px] font-medium ${kindColor[i.kind]}`}
                  >
                    {kindLabel[i.kind]}
                  </span>
          ...
          {count > COLLAPSED_COUNT && (
            <button
              ...
              className="self-start text-[11px] text-neutral-500 underline decoration-dotted"
            >
