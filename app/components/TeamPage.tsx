                    ...
                    <div className="flex flex-col gap-3 pr-5">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          {(dayDetail.day_type === "camp" ||
                            ...
                            <button
                              ...
                              className="rounded px-2 py-1 text-[length:calc(11px+var(--fs-add))] font-medium text-red-400 underline"
                            >
                              この予定を削除する
                            </button>
                          )}
                      ...
                      {dayDetail.sessions.map((s) => (
                        ...
                        >
                          ...
                          {s.location_note ? (
                            <p className="mb-2 rounded bg-purple-950/40 px-2 py-1 text-[length:calc(11px+var(--fs-add))] text-purple-400">
            ...
            {cells.map((date, i) => {
              ...
              return (
                ...
                >
                  ...
                  {day?.is_off && (
                    <span className="text-[length:calc(9px+var(--fs-add-mini))] text-neutral-500 dark:text-neutral-500">
                      全体オフ
                    </span>
                  )}
                  {day &&
                    ...
                    (day.day_type === "camp" ||
                      ...
                      day.day_type === "away") && (
                      <span
                        className={`max-w-full truncate rounded px-1 text-[length:calc(9px+var(--fs-add-mini))] font-semibold ${dayTypeFillColorDark[day.day_type]}`}
                      >
                  ...
                  {isCoach ? (
                    ...
                    day.sessions.map((s) => (
                      ...
                      >
                        ...
                        />
                        <span className="break-words text-[length:calc(9px+var(--fs-add-mini))] text-neutral-600 dark:text-neutral-300">
                          {sessionTypeLabel[s.session_type]}
