        ...
        {cells.map((date, i) => {
          ...
          return (
            <button
              ...
              className={`relative flex min-h-[56px] flex-col items-center justify-start gap-0.5 rounded-lg border border-neutral-700 pt-1 text-xs active:bg-neutral-700 ${
                isHighlighted
